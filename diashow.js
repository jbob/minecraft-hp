(function($) {
	...
	$.fn.initDiashow = function() {
			...
			for(var i=0; i<$(this).length;i ++) {
				...
				top.prepend("<h3>"+(a.attr("title") ? a.attr("title") : "")+"</h3>");
				top.append("<img/>");
			...
			$(this).children("img").click(function() {
				...
				top.children("h3").html(elem.attr("title") ? elem.attr("title") : "");
				a.toggleClass("diashowPos");
				elem.toggleClass("diashowPos");
				top.children("span").html("Bild "+(top.children("a").index(elem)+1)
																	+" von "+top.children("a").length);
